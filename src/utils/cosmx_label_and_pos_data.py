...
df = pd.read_csv('cosmx_measurements_data.csv')
...
measurements.to_csv('cosmx_measurements.csv', index=False, header=True, sep=',')
del measurements
...
label.to_csv('cosmx_label.csv', index=False, header=True, sep=',')
