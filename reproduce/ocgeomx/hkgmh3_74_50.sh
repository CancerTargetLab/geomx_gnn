...
do
    ...
    python -m main --model_type Image2Count --raw_subset_dir hkgmh3_74_50 --batch_size_graph 64 --num_workers_graph 8 --num_node_features 32 \
    ...
    python -m main --model_type Image2Count --raw_subset_dir hkgmh3_74_50 --batch_size_graph 64 --num_workers_graph 8 --num_node_features 32 --num_gat_features 8 \
    ...
    python -m main --model_type LIN --raw_subset_dir hkgmh3_74_50 --batch_size_graph 64 --num_workers_graph 8 --num_node_features 32 \
