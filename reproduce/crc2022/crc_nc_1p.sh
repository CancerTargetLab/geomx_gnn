...
do
    ...
    python -m main --model_type Image2Count --raw_subset_dir CRC_nc_1p --batch_size 64 --num_workers 8 --num_node_features 32 \
    ...
    python -m main --model_type Image2Count --raw_subset_dir CRC_nc_1p --batch_size 64 --num_workers 8 --num_node_features 32 --num_gat_features 32 \
    ...
    python -m main --model_type LIN --raw_subset_dir CRC_nc_1p --batch_size 64 --num_workers 8 --num_node_features 32 \
