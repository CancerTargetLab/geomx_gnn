...
python -m main --image_preprocess --preprocess_dir data/raw/CRC_2c_1p/train/ --cell_cutout 34 --preprocess_workers 20 \
        --calc_mean_std --preprocess_channels 0,10
python -m main --image_preprocess --preprocess_dir data/raw/CRC_2c_1p/test/ --cell_cutout 34 --preprocess_workers 10 \
        --preprocess_channels 0,10

python -m main --train_image_model --output_name out/models/crc_2c_1p_image_model_res18_32_16.pt --early_stopping 1000 \
...
python -m main --embed_image_data --output_name_image out/models/crc_2c_1p_image_model_res18_32_16.pt \
...
python -m main --model_type Image2Count --raw_subset_dir CRC_2c_1p --batch_size 64 --epochs 300 --num_workers 20 \
...
python -m main --model_type Image2Count --raw_subset_dir CRC_2c_1p --batch_size 64 --epochs 300 --num_workers 20 \
        ...
        --early_stopping 25 --heads 8 --node_dropout 0.05 --embed_dropout 0.1 --edge_dropout 0.3 --data_use_log_graph \
        --train_gnn --num_cfolds 10 --subgraphs_per_graph 49 --num_hops 11 --weight_decay 5e-4
python -m main --model_type LIN --raw_subset_dir CRC_2c_1p --batch_size 64 --epochs 300 --num_workers 20 \
...
do
    ...
    python -m main --visualize_model_run --model_path out/models/crc_2c_1p_lin/$m.pt --output_model_name CRC_2c_1p_"$m"_lin --figure_model_dir figures/crc_2c_1p/lin/$m/

done

python -m main --vis_label_data CRC_1p_label.csv --processed_subset_dir CRC_2c_1p/test --figure_dir figures/crc_2c_1p/35_0/mean/ --merge \
        --embed_dir out/crc_2c_1p_35_0/ --vis_name crc_2c_1p_35_0_mean --visualize_expression --has_expr_data --raw_subset_dir CRC_2c_1p
python -m main --visualize_image --vis_name crc_2c_1p_35_0_mean.h5ad --vis_img_raw_subset_dir CRC_2c_1p --name_tiff CRC03.ome.tif \
...
python -m main --vis_label_data CRC_1p_label.csv --processed_subset_dir CRC_2c_1p/test --figure_dir figures/crc_2c_1p/24_6/mean/ --merge \
        --embed_dir out/crc_2c_1p_24_6/ --vis_name crc_2c_1p_24_6_mean --visualize_expression --has_expr_data --raw_subset_dir CRC_2c_1p
python -m main --visualize_image --vis_name crc_2c_1p_24_6_mean.h5ad --vis_img_raw_subset_dir CRC_2c_1p --name_tiff CRC03.ome.tif \
        --figure_img_dir figures/crc_2c_1p/24_6/mean/crc03/ \
        --vis_protein Hoechst1,CD3,Ki67,CD4,CD20,CD163,Ecadherin,LaminABC,PCNA,NaKATPase,Keratin,CD45,CD68,FOXP3,Vimentin,Desmin,Ki67_570,CD45RO,aSMA,PD1,CD8a,PDL1,CDX2,CD31,Collagen \
        --vis_img_xcoords 22201 25893 --vis_img_ycoords 14729 18421 --vis_all_channels

python -m main --vis_label_data CRC_1p_label.csv --processed_subset_dir CRC_2c_1p/test --figure_dir figures/crc_2c_1p/lin/mean/ --merge \
        --embed_dir out/crc_2c_1p_lin/ --vis_name crc_2c_1p_lin_mean --visualize_expression --has_expr_data --raw_subset_dir CRC_2c_1p
python -m main --visualize_image --vis_name crc_2c_1p_lin_mean.h5ad --vis_img_raw_subset_dir CRC_2c_1p --name_tiff CRC03.ome.tif \
