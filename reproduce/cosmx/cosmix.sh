...
python -m main --train_image_model --output_name out/models/nanostring_image_model_166_516_128.pt --early_stopping 1000 --embed 512 --contrast 128 --resnet '50'  --num_workers 30 --epochs 300 --warmup_epochs 30 --crop_factor 0.5 --batch_size 512 --raw_subset_dir nanostring --n_clusters_image 30 --lr 0.1
...
python -m main --embed_image_data --output_name out/models/nanostring_image_model_166_516_128.pt --early_stopping 1000 --embed 512 --contrast 128 --resnet '50'  --num_workers 30 --epochs 300 --warmup_epochs 30 --crop_factor 0.5 --batch_size 512 --raw_subset_dir nanostring
...
do
    ...
    python -m main --model_type Image2Count --raw_subset_dir nanostring --batch_size 64 --num_workers 8 --num_node_features 512 \
    ...
    python -m main --vis_select_cells 50000 --vis_label_data nanostring_label.csv --processed_subset_dir nanostring/test --figure_dir figures/nanostring/6_6/$m/ \
            --embed_dir out/nanostring_6_6/$m/ --vis_name nanostring_6_6_$m --visualize_expression --has_expr_data --raw_subset_dir nanostring
    ...
    python -m main --model_type Image2Count --raw_subset_dir nanostring --batch_size 64 --num_workers 8 --num_node_features 512 --num_gat_features 64 \
    ...
    python -m main --visualize_model_run --model_path out/models/nanostring_17_0/$m.pt --output_model_name nanostring_"$m"_17_0 --figure_model_dir figures/nanostring/17_0/$m/

    python -m main --model_type LIN --raw_subset_dir nanostring --batch_size 64 --num_workers 8 --num_node_features 512 \
...
python -m main --visualize_image --vis_name nanostring_6_6_mean.h5ad --vis_img_raw_subset_dir nanostring/test --name_tiff 20210706_105344_S2_C902_P99_N99_F020_Z001.TIF --vis_all_channels \
        ...
        --figure_img_dir figures/nanostring/6_6/mean/20210706_105344_S2_C902_P99_N99_F020_Z001/
...
python -m main --visualize_image --vis_name nanostring_17_0_mean.h5ad --vis_img_raw_subset_dir nanostring/test --name_tiff 20210706_105344_S2_C902_P99_N99_F020_Z001.TIF --vis_all_channels \
        --vis_protein 'PTPRC,CD74,CD9,CD163,CD68,CD14,CD4,CD34,CD3D,CD3E,CD3G,CDH1,MKI67,TP53,ICOS,IDO1,HLA-A,HLA-B,HLA-C,KRT1,KRT14,KRT15,TYK2,KRT17,KRT19,JAG1,MTRNR2L1,CRP,TM4SF1,PTGDR2,C1QA,MS4A1,MS4A4A,MET,CD8A,CD8B,CD84,CD127,FN1,FOXP3,DDR1,CTLA4,CD44,CD274,CD37' \
        --figure_img_dir figures/nanostring/17_0/mean/20210706_105344_S2_C902_P99_N99_F020_Z001/
...
python -m main --visualize_image --vis_name nanostring_lin_mean.h5ad --vis_img_raw_subset_dir nanostring/test --name_tiff 20210706_105344_S2_C902_P99_N99_F020_Z001.TIF --vis_all_channels \
        --vis_protein 'PTPRC,CD74,CD9,CD163,CD68,CD14,CD4,CD34,CD3D,CD3E,CD3G,CDH1,MKI67,TP53,ICOS,IDO1,HLA-A,HLA-B,HLA-C,KRT1,KRT14,KRT15,TYK2,KRT17,KRT19,JAG1,MTRNR2L1,CRP,TM4SF1,PTGDR2,C1QA,MS4A1,MS4A4A,MET,CD8A,CD8B,CD84,CD127,FN1,FOXP3,DDR1,CTLA4,CD44,CD274,CD37' \
        --figure_img_dir figures/nanostring/lin/mean/20210706_105344_S2_C902_P99_N99_F020_Z001/
